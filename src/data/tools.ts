...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    category: 'Image',
    subcategory: 'Transform',
    keywords: ['compress image online', 'compress jpg online', 'reduce jpg size', 'compress png', 'image compressor', 'shrink image file', 'reduce image size free'],
    live: true,
  },
  {
    slug: 'svg-optimizer',
